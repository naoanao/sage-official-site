...
class MarketScanNotifier:
    ...
    def _fetch_growl_revenue(self) -> str:
        """Growl /api/revenue-report から週次収益を取得する。"""
        try:
            ...
            req = urllib.request.Request(
                f"{growl_url}/api/revenue-report",
            ...
            logger.warning(f"[NOTIFIER] Revenue fetch failed: {e}")
            return ""
    ...
    def _build_text(self, scan_result: dict[str, Any], platform: str = "slack") -> str:
        ...
        # Growl売上を取得
        revenue_line = self._fetch_growl_revenue()
