...
const STATIC_LINKS = {
    whop:       import.meta.env.VITE_WHOP_URL       || '#',
    gumroad:    import.meta.env.VITE_GUMROAD_URL    || '#',
    paypal:     import.meta.env.VITE_PAYPAL_URL     || '#',
    proMonthly: import.meta.env.VITE_STRIPE_PRO_URL || '#',
    enterprise: import.meta.env.VITE_STRIPE_ENT_URL || '#',
};
...
const STATS = [
    { value: '~30', label: 'min setup (one-time)' },
        ...
        <div className="min-h-screen bg-black text-white font-sans selection:bg-blue-500/30 overflow-x-hidden">
            ...
            <section className="relative min-h-[80vh] flex flex-col items-center justify-center px-4 pt-24 pb-16 z-10 text-center">
                ...
                >
                    ...
                    <p className="text-xl text-slate-500 font-light mb-4">SNS cloud layer needs no PC. Blog & chat run locally.</p>

                    <p className="text-base md:text-lg text-slate-400 max-w-2xl mx-auto mb-6 font-light leading-relaxed">
                        Sage AI is a self-hosted toolkit you deploy to your own Cloudflare account. The SNS automation runs 24/7 on Cloudflare's global edge — every morning it pulls from your Notion content pool, generates AI-written posts, and publishes to Bluesky and Instagram. Setup takes ~30 minutes.
                    </p>
                    ...
                    <p className="text-xs text-slate-600 mt-3">Cancel anytime · Setup guide included · You own the code</p>
                </Motion.div>
            </section>
                ...
                <div className="max-w-2xl mx-auto text-center">
                    ...
                    >
                        ...
                        <p className="text-slate-400 mb-10 text-sm">
                            Setup takes ~30 minutes (Python + Node.js + 6 API keys). After that, your SNS automation posts to social media every single morning — automatically, no PC needed.
                        </p>
                        ...
                        <div className="flex flex-wrap justify-center gap-4 text-xs text-slate-500">
                            ...
                            <span className="flex items-center gap-1"><FiCheck size={11} className="text-emerald-400" /> Setup guide + source code included</span>
                            <span className="flex items-center gap-1"><FiCheck size={11} className="text-emerald-400" /> Access within 24h (manual delivery)</span>
