                                                                        ...
                                                                        disable_comment = false,
                                                                              direct_post = false,
                                                                                      ...
                                                                                      if (!device_id || !video_url) {
                                                                                            return NextResponse.json({ error: "device_id and video_url are required" }, { status: 400 });
                                                                                                }
                                                                                                                                                                      ...
                                                                                                                                                                      ? "https://open.tiktokapis.com/v2/post/publish/video/init/"
                                                                                                                                                                            : "https://open.tiktokapis.com/v2/post/publish/inbox/video/init/";
                                                                                                                                                                                ...
                                                                                                                                                                                const postBody: Record<string, unknown> = {
                                                                                                                                                                                      post_info: { title: title.slice(0, 2200), privacy_level, disable_duet, disable_stitch, disable_comment },
                                                                                                                                                                                            source_info: { source: "PULL_FROM_URL", video_url },
                                                                                                                                                                                                };
                                                                                                                                                                                                    if (direct_post) postBody.post_mode = "DIRECT_POST";
                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                            return NextResponse.json({ error: postData.error.message, detail: postData }, { status: 400 });
                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                    const publishId = postData.data?.publish_id;
                                                                                                                                                                                                                                                        await supabase.from("tiktok_post_log").insert({
                                                                                                                                                                                                                                                              device_id, publish_id: publishId, video_url, title, direct_post,
                                                                                                                                                                                                                                                                    status: direct_post ? "published" : "uploaded_to_inbox",
                                                                                                                                                                                                                                                                          created_at: new Date().toISOString(),
                                                                                                                                                                                                                                                                              });

                                                                                                                                                                                                                                                                                  return NextResponse.json({ success: true, publish_id: publishId, mode: direct_post ? "direct_post" : "upload_to_inbox" });
                                                                                                                                                                                                                                                                                    } catch (err) {
