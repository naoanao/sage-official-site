...
- 各アクションは「個人事業主がスマホ一台で今週中に30分以内・費用ゼロで完結できること」を必須条件とする。大規模な施策・インフルエンサー起用・広告予算が必要な内容は禁止
...
- E（経済・市場動向）: 物価・景気・市場規模・所得・金利・為替・競合の価格動向のみ。消費者の意識変化・食トレンドはEに含めない
- S（社会・トレンド）: 消費者意識の変化・ライフスタイル・人口動態・健康志向・食トレンド・社会的価値観はすべてここに分類する
