...
function track(event, extra = {}) {
  const IS_L = typeof window !== 'undefined' &&
  ...
  fetch('/api/track', {
    ...
    body: JSON.stringify({ event, session_id: sid, metadata: extra }),
  }).catch(() => {});
}
import {
                    ...
                    >
                        ...
                        <div className="bento-card bento-card-accent card-accent-top p-7 flex-1">
                            ...
                            <a
                                ...
                                onClick={() => track('payment_click', { plan: 'pro', source: 'landing' })}
                        ...
                        <div className="bento-card p-7 flex-1">
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                onClick={() => track('payment_click', { plan: 'enterprise', source: 'landing' })}
                                className="flex items-center justify-center gap-2 w-full py-3 rounded-xl text-white font-bold text-sm transition-all duration-200"
                                style={{
